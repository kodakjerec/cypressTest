...
import testData from '../../fixtures/3-PROD/0.0.0-sample.json';
...
describe('輸入測試', () => {
  ...
  it('登入', () => {
    ...
    cy.get('input[formcontrolname="uname"]').type(testData.userId);
    cy.get('input[formcontrolname="pin"]').type(testData.pin);
    solver();
